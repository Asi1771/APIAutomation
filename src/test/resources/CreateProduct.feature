Feature: creates a product
  ...
  Scenario: user successfully creates a product
    ...
    And I have "product_title" with "pasta" in request body
    ...
    And verify I have "product_title" with "pasta" in response body
...
@dbTest1
  Scenario: user successfully creates a product, verify product in DB
    And I have access
    And I have the endpoint "/products"
    And I have "product_title" with "kiwi" in request body
    And I have "product_price" with "2.99" in request body
    And I have "service_type_id" with "2" in request body
    And I have "category_id" with "1" in request body
    And I have "product_description" with "coffee beans" in request body
    ...
    When I send POST request
    Then verify status code is 201
    And verify I have "product_title" with "kiwi" in response body
    And verify "product_title" with "kiwi" is in database
    Then I delete the product
    Then verify the product is not present in products list
    And verify "product_title" with "kiwi" is not in database
